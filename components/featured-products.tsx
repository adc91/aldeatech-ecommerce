    ...
    <section className="w-full">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Check out our handpicked selection of trending products with the best deals
        </p>
      </div>
          ...
          {Array.from({ length: maxIndex + 1 }).map((_, index) => (
            <button
              ...
              className={cn(
                ...
                currentIndex === index ? "bg-primary w-8" : "bg-muted-foreground/30 hover:bg-muted-foreground/50",
              )}
