        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            {categories.map((category) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-all duration-200 border border-gray-200 group-hover:scale-105 ${
                    activeCategory === category.name ? "bg-gray-900 text-white" : "bg-white group-hover:bg-gray-50"
                  }`}
                >
                ...
                <span
                  className={`mt-2 text-sm font-medium transition-colors duration-200 ${
                    activeCategory === category.name ? "text-gray-900" : "text-gray-700 group-hover:text-gray-900"
                  }`}
                >
                  {category.name}
                </span>
